...
//   // this.src = player == 1 ? "assets/SmileHead2.png" : "assets/kimkhead2.png";
//   this.id = id.toString();
//   id++;
...
//   this.image.src = player == 1 ? 'assets/SmileHead2.png' : 'assets/KimKHead2.png';
//   // this.image.classList.add('');
//   this.image.setAttribute('id', `d${this.id}`);
//   this.id = id.toString();
//   id++;
//   this.addToScene = function(){
//     // board.innerHTML += '<div id="d'+this.id+'" class="disc '+this.color+'"></div>';
//     board.innerHTML += `${this.image}`;
//     if(currentPlayer==2){
//       //computer move
//       var possibleMoves = think();
//       var cpuMove = Math.floor( Math.random() * possibleMoves.length);
...
function Disc(player){
  this.player = player;
  this.color = player == 1 ? 'red' : 'yellow';
  // this.image = image == 1 ? 'assets/SmileHead2.png' : 'assets/KimKHead2.png';
  this.id = id.toString();
  id++;
